...
$id = $_GET["id"];
          $sqlw = "SELECT * FROM member WHERE id_member='$id' ";
...
<!DOCTYPE html>
<html>
<title> แก้ไขข้อมูลสมาชิก|<?php echo$sys_title;?></title>
<meta charset="UTF-8">
...
<h2 style="text-align: center"><b><i class="fa fa-users fa-fw"></i> การจัดการลูกค้า|แก้ไขลูกค้า</b></h2>
<hr>

<div class="col-sm-8" style="padding-top:45px">
<form action="admin_member_edit_acc.php" method="POST" name="form1" enctype="multipart/form-data">    
...
<input name="id" type="hidden" id="id" value="<?php echo $rs['id_member']?>" />     
</TD>
</TR>
</TABLE>
</FORM>           </div>
