...
<body class="w3-light-grey">
    ...
    <div class="w3-main" style="margin:20px 0px 0px 300px">
        ...
        <div style="padding-top:45px;padding-bottom:5px">
            <center>
                <h2 style="text-align: center"><b><i class="fa fa-sticky-note"></i> รายงานเบ็ดเตล็ด</b></h2>
            </center>
        </div>
 ...
 <option value="admin_report_other.php">รายงานเบ็ดเตล็ด</option>
       ...
       $sql = "select * from other  where other_date between '".$_POST["startdate"]."' and '".$_POST["enddate"]."'";
                        ...
                        <!-- วนลูปแสดงผล & รวมยอดขายทั้งหมด-->
                         <?php 
                            while ($row = mysqli_fetch_array($query)) {
                                $i += 1;
                                $total += $row["other_date"];
                        ?>
                        <tr>
                            <td class="text-center"><?php echo $i; ?></td>
                            <td class="text-center"><?php echo $row["other_name"]; ?></td>
                            <td class="text-center"><?php echo $row["other_price"]; ?></td>
                            <td class="text-center"><?php echo $row["other_date"]; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4" class="text-right">
                                <div class="ml-auto" style="font-size: 18px;font-family: Prompt">
                                    ...
                                    <span class="font-weight-bold"><?php echo $total; ?> บาท</span></div>                            </td>

                            <!-- แสดงผลรวมยอดขายทั้งหมด -->
                            <td style="font-size: 18px;font-family: Prompt">&nbsp;</td>
                        </tr>
                    </table>
                    <!-- Exit Else -->
                    <?php } ?>
